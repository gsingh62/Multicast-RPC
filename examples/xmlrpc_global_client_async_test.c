...
xmlrpc_client_call_asynch(numServers,methodName,handle_sample_add_response,NULL,"(ii)", (xmlrpc_int32) 5, (xmlrpc_int32) 7,any_or_majority,serverUrl1,serverUrl2,serverUrl3);
    	dieIfFaultOccurred(&env);
